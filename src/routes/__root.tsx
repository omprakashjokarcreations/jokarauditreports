  ...
  head: () => ({
    meta: [
      ...
      { title: "Client Digital Presence Audit — Jokar Creations" },
      {
        name: "description",
        content:
          "A professional audit of client digital presence — websites, LinkedIn activity and opportunities identified by Jokar Creations Pvt. Ltd.",
      },
      { name: "author", content: "Jokar Creations Pvt. Ltd." },
      { property: "og:title", content: "Client Digital Presence Audit — Jokar Creations" },
      {
